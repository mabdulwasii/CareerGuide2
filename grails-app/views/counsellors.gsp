        ...
        <section class="row">
                ...
                <form class="col s12">
                    <div class="row">
                        <div class="input-field col s8 offset-s2 search ">
                            ...
                            <input id="icon_prefix" class="validate browser-default white teal-text hoverable" placeholder="Search for Institutions, Courses, ..." >
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="fixed-action-btn toolbar">
                ...
                <ul class="">
                    ...
                    <li class="waves-effect waves-light"><a href="#!">Privacy</a></li>
