...
<html>
    ...
    <body>
        ...
        <div id="show-finance" class="content scaffold-show" role="main">
            ...
            <f:display bean="finance" />
            <g:form resource="${this.finance}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.finance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
